...
Running tests requires the `Webgoat application`_ located under ``webgoat Directory``

After the demo application is started, provide the base url int he requirement
